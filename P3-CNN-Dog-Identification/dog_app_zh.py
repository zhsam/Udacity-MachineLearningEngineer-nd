...
# __回答1:__ 
# 
# - `human_files` 的前100张图像中，能够检测到**人脸**的图像占100%
# - `dog_files` 的前100张图像中，能够检测到**人脸**的图像占11%
...
# 
# 我认为这样的要求在实际中对用户不合理。
# 我认为除了面部特征之外，应该加上人脸外型轮廓、肤色面积、头发等等，作为其中的特征。
# 除此之外，应该在训练的时候加入各种的侧脸的图片，增强对于面部特征不过清晰情况下的识别。
...
# __回答4:__ 
# 
# 上图提示的架构为标准的深度学习网络架构，由卷积层与池化层相间而成，最后为Dense层。<br>
# 其中卷积层提取特征，池化层避免过拟合。<br>
